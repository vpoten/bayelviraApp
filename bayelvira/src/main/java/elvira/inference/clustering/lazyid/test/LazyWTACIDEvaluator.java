...
import elvira.inference.clustering.lazyid.LazyPropagationIDWithPTAC;
 ...
 * @author mgomez
 */
public class LazyWTACIDEvaluator implements IDEvaluator {
    ...
    * @param netName
    */
   public LazyWTACIDEvaluator(String netName) {
      if (generateDebugInfo) {
         System.out.println("LazyWTACIDEvaluator:  class Constructor ----- BEGIN");
      }
      ...
      result = new ExperimentResult(netName, EnumAlgorithms.LAZYWTAC);
      if (generateDebugInfo) {
         System.out.println("LazyWTACIDEvaluator:  class Constructor ----- END");
      }
   }
   ...
   public void run() {
      if (generateDebugInfo) {
         System.out.println("LazyWTACIDEvaluator:  run ----- BEGIN");
      }

      // Creates the evaluator
      LazyPropagationIDWithPTAC evaluator = new LazyPropagationIDWithPTAC(diagram, 0, IDPairTable.WEIGHTFILL,
      ...
      if (generateDebugInfo) {
         System.out.println("LazyWTACIDEvaluator:  run ----- END");
      }
   }
