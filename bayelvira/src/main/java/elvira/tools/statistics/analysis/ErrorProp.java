...
public class ErrorProp{
        ...
        // Copy a single ErrorProp number [non-static method]
        ...
        // ADDITION
        // Add two ErrorProp numbers with correlation [non-static method]
        ...
        //Add a ErrorProp number to this ErrorProp number with no, i.e. zero, correlation [non-static method]
        ...
        // Add an error free double number to this ErrorProp number [non-static method]
        // this ErrorProp number remains unaltered
       ...
       //Add an error free double number to an error free double and return sum as ErrorProp [static method]
        ...
        // SUBTRACTION
        // Subtract an ErrorProp number from this ErrorProp number with correlation [non-static method]
        // this ErrorProp number remains unaltered
        ...
        // Subtract a ErrorProp number from this ErrorProp number with no, i.e. zero, correlation [non-static method]
        // this ErrorProp number remains unaltered
        ...
        // Subtract an error free double number from this ErrorProp number [non-static method]
        // this ErrorProp number remains unaltered
        ...
        //      MULTIPLICATION
        //Multiply two ErrorProp numbers with correlation [non-static method]
        ...
        //Multiply this ErrorProp number by a ErrorProp number [non-static method]
        ...
        //Multiply this ErrorProp number by a double [non-static method]
        // this ErrorProp number remains unaltered
        ...
        // DIVISION
        // Division of this ErrorProp number by a ErrorProp number [non-static method]
        // this ErrorProp number remains unaltered
        // with correlation
        ...
        //Division of this ErrorProp number by a double [non-static method]
        // this ErrorProp number remains unaltered
        ...
        // RECIPROCAL
               // Returns the reciprocal (1/a) of a ErrorProp number (a) [non-static method]
        ...
        //Absolute value  [non-static method]
