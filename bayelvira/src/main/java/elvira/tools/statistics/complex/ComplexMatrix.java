...
package elvira.tools.statistics.complex;
...
/*********************************************************/
    	...
    	public static ComplexMatrix scalarMatrix(int nrow, Complex diagconst){
        	ComplexMatrix u = new ComplexMatrix(nrow, nrow);
        	Complex[][] uarray = u.getArrayPointer();
        	for(int i=0; i<nrow; i++){
    	...
    	public ComplexMatrix getSubMatrix(int i, int j, int k, int l){
        	...
        	Complex[][] sarray = this.getArrayPointer();
        	for(int p=0; p<n; p++){
            		for(int q=0; q<m; p++){
    	...
    	public static ComplexMatrix copy(ComplexMatrix a){
        	int nr = a.getNrow();
        	int nc = a.getNcol();
        	Complex[][] aarray = a.getArrayPointer();
        	ComplexMatrix b = new ComplexMatrix(nr,nc);
        	b.nrow = nr;
        	b.ncol = nc;
        	Complex[][] barray = b.getArrayPointer();
        	for(int i=0; i<nr; i++){
            		for(int j=0; j<nc; j++){
    	...
    	// Copy a ComplexMatrix [non-static method]
    	...
    	// ADDITION
    	// Add this matrix to matrix B.  This matrix remains unaltered [non-static method]
    	public ComplexMatrix plus(ComplexMatrix bmat){
        	...
        	Complex[][] carray = cmat.getArrayPointer();
        	for(int i=0; i<nr; i++){
            		for(int j=0; j<nc; j++){
    	...
    	// SUBTRACTION
    	// Subtract matrix B from this matrix.   This matrix remains unaltered [non-static method]
    	...
    	// MULTIPLICATION
    	// Multiply this complex matrix by a complex matrix.   [non-static method]
   	...
   	public ComplexMatrix times(ComplexMatrix bmat){
    	...
    	// Multiply this complex matrix by a complex constant [non-static method]
    	// This matrix remains unaltered
    	...
    	// Multiply this complex matrix by a real (double) constant [non-static method]
    	// This matrix remains unaltered.
   	...
   	// Multiply this matrix by a real (double) constant [equivalence of *=]
    	...
    	// INVERSE
    	// Inverse of a square complex matrix [non-static method]
    	public ComplexMatrix inverse(){
        	...
        	Complex[][] invarray = invmat.getArrayPointer();
    	...
    	// TRANSPOSE
    	// Transpose of a complex matrix [non-static method]
    	public ComplexMatrix transpose(){
        	ComplexMatrix tmat = new ComplexMatrix(this.ncol, this.nrow);
        	Complex[][] tarray = tmat.getArrayPointer();
    	...
    	// COMPLEX CONJUGATE
    	//Complex Conjugate of a complex matrix [non-static method]
    	...
    	// ADJOIN
    	// Adjoin of a complex matrix [non-static method]
    	...
    	// OPPOSITE
    	// Opposite of a complex matrix [non-static method]
    	...
    	// TRACE
    	// Trace of a complex matrix [non-static method]
    	...
    	// DETERMINANT
    	//  Returns the determinant of a complex square matrix [non-static method]
    	...
    	// Returns the log(determinant) of a complex square matrix [non-static method].
   	...
   	// Useful if determinant() underflows or overflows.
	    ...
	    public ComplexMatrix luDecomp(){
		    ...
		    Complex[][] ludarray = ludmat.getArrayPointer();
