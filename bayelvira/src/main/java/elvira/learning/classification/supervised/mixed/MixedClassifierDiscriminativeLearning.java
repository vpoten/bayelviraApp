...
public abstract class MixedClassifierDiscriminativeLearning extends MixedClassifier 
{ 
   ...
   */
  public MixedClassifierDiscriminativeLearning()
  {
    super();
    verbose = false;
   ...
   * @param boolean lap. To apply the laplace correction
   */
  public MixedClassifierDiscriminativeLearning(DataBaseCases data, boolean lap) throws elvira.InvalidEditException
  {
    super(data,lap);
    verbose = false;
